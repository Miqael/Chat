...
//        $this->controller=&$controller;
        $settings['ext'] = array('png', 'jpg','gif','jpeg');//,'pdf','doc','zip','tar.gz','gz','zip','rar','docx','txt' ,'xls' , 'xlsx' , 'xlsm' , 'xlam','odt','pptx');
        ...
        if(!is_null($settings) && is_array($settings)){
            ...
            if(isset($settings['limit']) && is_integer($settings['limit'])){
                ...
                $this->setSizeLimit(2000000);//5mb135224304
            }
        }
    }
    /**
...
class qqFileUploader {
    ...
    private function checkServerSettings(){
        ...
        if (($postSize < $this->sizeLimit && $postSize != '-1') || ($uploadSize < $this->sizeLimit && $uploadSize != '-1') ){
